    ...
    <body>
        ...
        <div id="nutritionfacts">
            <table width="242" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td><div class="serving">Por cada <span class="highlighted">100.0g</span></div></td>
                </tr>
                <tr style="height: 7px">
                    <td bgcolor="#000000"></td>
                </tr>
                <tr>
                    <td style="font-size: 7pt"><div class="line">Cantidad por cada 100g</div></td>
                </tr>
                <tr>
                    <td>
                        <div class="line">
                        <div class="label">Calorias <div class="weight"></div></div>
                ...
                <tr>
                    <td>
                        <div class="line">
                        <div class="label">Grasas <div class="weight"></div></div>
                    ...
                    <td class="indent">
                        <div class="line">
                        <div class="labellight">De las cuales saturadas: <div class="weight"></div></div>
                    ...
                    <td class="indent">
                        <div class="line">
                        <div class="labellight">De las cuales monosaturadas: <div class="weight"></div></div>
                    ...
                    <td>
                        <div class="line">
                        <div class="label">De las cuales trans: <div class="weight"></div></div>
                    ...
                    <td>
                        <div class="line">
                        <div class="label">Carbohidratos: <div class="weight"></div></div>
                ...
                <tr>
                    <td>
                        <div class="line">
                        <div class="label">Proteinas: <div class="weight"></div></div>
                ...
                <tr style="height: 7px">
                    ...
                    <td>
                        ...
                        <tr>
                            ...
                            <td style="margin-left:79px;float:left;">Calcio   {{$valor_alimento->calcio}}g</td>
                        </tr>
                        <tr>
                            <td>Almidon {{$valor_alimento->almidon}}g</td>
                            <td style="margin-left:80px;float:left;">Sodio   {{$valor_alimento->sodio}}g</td>
                        </tr>
                        <tr>
